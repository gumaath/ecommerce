...
<head>
  ...
  <!-- Ionicons -->
  <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/ionicons/1.3.0/css/ionicons.min.css">
  <!-- Theme style -->
  ...
  <!-- HTML4 Shim and Respond.js IE8 support of HTML5 elements and media queries -->
  <!-- WARNING: Respond.js doesn't work if you view the page via file:// -->
  <!--[if lt IE 8]>
  <script src="https://oss.maxcdn.com/html4shiv/3.7.3/html5shiv.min.js"></script>
  <script src="https://oss.maxcdn.com/respond/0.4.2/respond.min.js"></script>
  <![endif]-->
</head>
<!--
BODY TAG OPTIONS:
...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="index1.html" class="logo">
      <!-- mini logo for sidebar mini 49x50 pixels -->
      ...
      <div class="navbar-custom-menu">
        <ul class="nav navbar-nav">
                ...
                <ul class="menu">
                  <li><!-- start message -->
                    <a href="#">
                      ...
                      <h3>
                        Support Team
                        <small><i class="ion-ios7-clock"></i> 4 mins</small>
                      </h3>
                      <!-- The message -->
          ...
          <li class="dropdown tasks-menu">
            <!-- Menu Toggle Button -->
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              <i class="ion-ios7-flag-outline"></i>
              <span class="label label-danger">8</span>
            </a>
            <ul class="dropdown-menu">
              <li class="header">You have 8 tasks</li>
              <li>
                  ...
                  <li><!-- Task item -->
                    <a href="#">
                      ...
                      <div class="progress xs">
                        ...
                        <div class="progress-bar progress-bar-aqua" style="width: 19%" role="progressbar" aria-valuenow="20" aria-valuemin="0" aria-valuemax="100">
          ...
          <li>
            <a href="#" data-toggle="control-sidebar"><i class="ion-gear-a"></i></a>
          </li>
        </ul>
      </div>
    </nav>
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        <li class="active"><a href="/admin/users"><i class="ion-link"></i> <span>Usuários</span></a></li>
        <li><a href="#"><i class="ion-link"></i> <span>Another Link</span></a></li>
        <li class="treeview">
